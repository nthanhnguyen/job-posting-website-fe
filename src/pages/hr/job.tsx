...
import { fetchJobForHr } from "@/redux/slice/jobHrSlide";

const JobPageForHr = () => {
    const tableRef = useRef<ActionType>();

    const isFetching = useAppSelector(state => state.job_hr.isFetching);
    const meta = useAppSelector(state => state.job_hr.meta);
    const jobs = useAppSelector(state => state.job_hr.result);
